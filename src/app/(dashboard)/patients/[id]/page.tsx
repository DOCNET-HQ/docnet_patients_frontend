                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="w-full mt-6 space-y-3 text-left">
                            ...
                            <div className="flex items-center justify-between gap-3 text-sm">
                                ...
                                <Button variant="outline" size="sm" className="bg-blue-600 hover:bg-blue-700 text-white cursor-pointer">
                                    View
            ...
            <div className="-mb-6">
                <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        {/* <h1 className="text-lg sm:text-xl font-semibold">Doctor Profile</h1> */}
                    </div>
                                        ...
                                        <div key={index} className="flex items-center justify-between gap-3">
                                            <div className="flex items-center gap-3 min-w-0 flex-1">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    <div className="text-xs text-muted-foreground truncate">{connection.specialty}</div>
                                                </div>
                                            </div>
                                            <Button
