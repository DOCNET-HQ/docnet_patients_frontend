...
export function ChatMain() {
  ...
  return (
    <div className="mx-4 flex flex-1 flex-col rounded-lg shadow-sm max-h-[97%]">
      <div className="flex items-center justify-between border border-b p-4 rounded-lg">
      ...
      <div className="flex items-center gap-3 border border-t p-4 rounded-lg">
